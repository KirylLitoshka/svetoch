...
routes = [
    ...
    web.route("GET", "/rates/{id}/history", RatesHistoryListView),
    web.route("POST", "/rates/{id}/history", RatesHistoryListView),
    ...
    web.route("GET", "/workshops/{id}/subobjects", WorkshopSubObjectsListView),
    web.route("POST", "/workshops/{id}/subobjects/{sub_id}", WorkshopSubObjectsListView),
    web.route("DELETE", "/workshops/{id}/subobjects/{sub_id}", WorkshopSubObjectsListView),
    ...
    web.route("GET", "/objects/{object_id}/renters", ObjectsSubRentersListView),
    web.route("POST", "/objects/{object_id}/renters", ObjectsSubRentersListView),
    web.route("DELETE", "/objects/{object_id}/renters/{sub_id}", ObjectsSubRentersListView),
    ...
    web.route("GET", "/calculations", CalculationDataListView),
    web.route("POST", "/calculations", CalculationDataListView),
    web.route("GET", "/calculation/{id}", CalculationDataDetailView),
    web.route("PATCH", "/calculation/{id}", CalculationDataDetailView),
    web.route("DELETE", "/calculation/{id}", CalculationDataDetailView),
    web.route("POST", "/test", test_handler)
]
